  ...
  return <section className="py-24 bg-white px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16 animate-fadeIn">
          <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Por Que Escolher Nosso Serviço?</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {features.map((feature, index) => <div key={feature.title} className="p-6 rounded-2xl bg-muted hover:bg-accent/20 transition-colors duration-300 animate-fadeIn" style={{
